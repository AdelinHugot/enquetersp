...
export const QUESTIONS_DECOUVERTE: Question[] = [
  ...
  // --- PHASE 2 : STATUT DU PROJET ---
  {
    ...
    options: [
      ...
      { id: 'attendais_vous', label: 'Je n\'attendais que vous' }
    ],
    required: true
  },
  {
  ...
  },
  {
    ...
    layout: 'grid',
    options: [
      { id: 'rien', label: 'Rien de prévu', icon: 'Ban' },
      { id: 'voiture_elec', label: 'Voiture élec', icon: 'Car' },
      { id: 'piscine', label: 'Piscine', icon: 'Waves' },
      { id: 'clim', label: 'Climatisation', icon: 'Snowflake' },
      { id: 'chauffage', label: 'Chauffage / ECS', icon: 'Thermometer' },
      { id: 'spa', label: 'SPA', icon: 'Sparkles' },
      { id: 'autre', label: 'Autre', icon: 'Plus', hasInput: true }
    ],
    required: true
  },
  {
  ...
  },
  {
    ...
    section: 'Découverte',
    text: 'Connaissez-vous les différentes façons de valoriser votre surplus solaire ?',
    type: 'multiple',
    layout: 'grid',
    options: [
  ...
  {
    id: 'batterie_physique',
    section: 'Découverte',
    text: 'Est-ce que vous souhaitez une batterie physique pour stocker votre surplus solaire ?',
    type: 'single',
    layout: 'grid',
    options: [
      { id: 'oui', label: 'Oui' },
  ...
  // --- PHASE 5 : FREINS ET PSYCHOLOGIE ---
  {
    ...
    options: [
      ...
      { id: 'attendais_rsp', label: 'J\'attendais RSP' },
      { id: 'autre', label: 'Autre', hasInput: true }
    ],
    required: true
  },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'mix', label: 'Mix' },
      { id: 'je_sais_pas', label: 'Je ne sais pas' }
    ],
    required: true
  },
